...
output_dir=/project2/kicp/tcallister/learning-p-det-data/param-study/lr_decay/moreHopeless_lr_1e-4_noEvol
mkdir -p $output_dir

output_file=$output_dir/$(printf "%02d" $SLURM_ARRAY_TASK_ID).json
echo "Writing to: " $output_file
python run_moreHopeless_lr_1e-4_noEvol.py $output_file
