...
output_dir=/project2/kicp/tcallister/learning-p-det-data/param-study/lr_decay/lr_1e-4_to_1e-6_step_10_delta_05
mkdir -p $output_dir

output_file=$output_dir/$(printf "%02d" $SLURM_ARRAY_TASK_ID).json
echo "Writing to: " $output_file
python run_lr_1e-4_to_1e-6_step_10_delta_05.py $output_file
