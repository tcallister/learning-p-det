...
output_dir=/project2/kicp/tcallister/learning-p-det-data/param-study/lr_decay/lr_1e-3_step_10_delta_10
mkdir -p $output_dir

output_file=$output_dir/$(printf "%02d" $SLURM_ARRAY_TASK_ID).json
echo "Writing to: " $output_file
python run_lr_1e-3_step_10_delta_10.py $output_file
