...
def input_output(data):
    ...
    input_data = data[['Mc_over_d','log_Mtot','eta','Xeff','Xp_gen','cos_inclination','right_ascension','sin_declination','polarization']]
...
def run_training(output):
    ...
    ann = build_ann(input_shape=9,layer_width=64,hidden_layers=3,lr=1e-4)
