...
result = PopulationResult(
        fname='popsummary_standardInjections.h5',
        )

# Load numpyro data
cdf_data = az.from_netcdf("output_standardInjections.cdf")
...
hyperparam_info = [
        ...
        ['mu_cost', "$\\mu_u$", "Mean of peaked part of cosine spin-tilt distribution"],
