...
certain_params['luminosity_distance'] = certain_params.distance/1000.  # Convert from Mpc to Gpc
...
certain_params['chirp_mass_detector'] = certain_params.eta**(3./5.)*(certain_params.m1_detector+certain_params.m2_detector)
certain_params['total_mass_detector'] = (certain_params.m1_detector+certain_params.m2_detector)
...
certain_params = certain_params[['m1_detector','m2_detector','luminosity_distance',
                'cos_inclination','right_ascension','declination',
                'polarization','redshift',
                'q','eta','chirp_mass_detector','total_mass_detector',
                'a1','a2','cost1','cost2',
                'Xeff','Xdiff','Xp_gen']]
